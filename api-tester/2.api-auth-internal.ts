...
import { extract_hex64, UserInfo } from './utils/hex64'
import get_password_token from './redis/password_token'
import { shared } from './shared'
import { get_config } from './config'

const API_AUTH_request = supertest(`${get_config().API_AUTH_addresse}:${get_config().API_AUTH_port}`);
