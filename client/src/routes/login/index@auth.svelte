...
<BlackBox>
	...
	<form action="" class="pt-1">
		...
		<p class="extra-link mt-2 float-right"><a href="/register">Forgot your password ?</a></p>
		<button class="mt-12 py-2 px-6 bg-blue-300 block m-auto rounded-sm">Login</button>
	</form>
