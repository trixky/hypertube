...
<div class="movie-container" style="transform: scale({scale}) translateY({-900 + h/ 2}px) translateX({-w/2}px);" bind:clientWidth={w} bind:clientHeight={h}>
    <div class="movies-container">
        {#each background_movies as movies_line, index}
        <div class="movie-line" style="animation-direction: {index % 2 === 0 ? "alternate" : "alternate-reverse"};">
